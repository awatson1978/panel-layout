...
module.exports = {
  "ActiveRecord::Table Walkthrough" : function (client) {
    ...
    .verify.containsText("#sortableListPanel #list .item:nth-child(2)", "vitamin d")
    .verify.containsText("#sortableListPanel #list .item:nth-child(3)", "tetracycline")
    .verify.containsText("#sortableListPanel #list .item:nth-child(4)", "epinephrine")
